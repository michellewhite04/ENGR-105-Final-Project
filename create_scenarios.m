...
%initialize tables
node_table = {
    'One', 1, 1, 1, 0, 0, 1000, 1000, 0, 0, 0, 0, 0;
    'Two', 1, 80, 80, 0, 0, 51000, 51000, 0, 0, 0, 0, 0;
    'Three', 1, 80, 80, 0, 0, 51000, 51000, 0, 0, 0, 0, 0;
    'Four', 1, 1, 1, 0, 0, 51000, 51000, 0, 0, 0, 0, 0;
    'Five', 1, 110, 110, 0, 0, 51000, 51000, 0, 0, 0, 0, 0;
    'Six', 1, 320, 320, 0, 0, 51000, 51000, 0, 0, 0, 0, 0;
    'begin', 1, 1, 1, 0, 0, 51000, 51000, 0, 0, 0, 0, 0};

path_table = {
    'SPA', 1, 1, 2, 0, 0, 0, 75, 75, 75, 75, 0, 0, 0, 0;
    'SPB', 1, 2, 3, 0, 0, 0, 75, 75, 75, 75, 0, 0, 0, 0;
    'SPC', 1, 3, 4, 0, 0, 0, 75, 75, 75, 75, 0, 0, 0, 0;
    'FPA', 1, 1, 6, 0, 0, 0, 50, 50, 50, 50, 0, 0, 0, 0;
    'FPB', 1, 6, 5, 0, 0, 0, 50, 50, 50, 50, 0, 0, 0, 0;
    'FPC', 1, 5, 4, 0, 0, 0, 50, 50, 50, 50, 0, 0, 0, 0;
    'intervening', 1, 7, 1, 0, 0, 0, 300, 300, 300, 300, 0, 0, 0, 0};
...
ATP_table = {1, 0, 7, 250, 250, 0, 1, 0, 10, 0, 10, [inf,inf], 0, 0, 2, 2, 600, 320, 0, 0, 60, 0, 0};
